...
{
    public abstract class EmarketingWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmarketingWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmarketingWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmarketingDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmarketingDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmarketingDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmarketingDbContext, Task<T>> func)
        {
            T result;
